...
@WebServlet(name = "TransactionHistoryGetter")
public class TransactionHistoryGetter extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!cookiesMap.containsKey("token")) {
            ...
            String reply = historyGetter.getPrevOrder(token, username, Integer.parseInt(id));
